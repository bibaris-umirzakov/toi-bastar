...
export default function Header() {
  return (
      <div className="flex items-center gap-6 justify-between p x-6 py-4">
          ...
          <button
              className="bg-[#FFA500] text-white px-4 py-2 rounded-full hover:bg-gray-100 transition whitespace-nowrap">
              Стать партнёром
          </button>
